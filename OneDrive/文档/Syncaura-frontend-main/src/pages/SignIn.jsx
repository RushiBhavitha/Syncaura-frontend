...
<div className="flex justify-center gap-4 mb-4">
  <button
    ...
    className="border p-2 rounded-md hover:shadow"
    onClick={() => console.log("Google Login")}
  ...
  <button
    ...
    className="border p-2 rounded-md hover:shadow disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center"
