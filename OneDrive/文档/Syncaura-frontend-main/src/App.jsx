...
// GitHub OAuth callback page — handles the redirect from GitHub after authorization.
// Route: /auth/github/callback (public, no auth required)
    ...
    <>
      ...
      <BrowserRouter>
        <Routes>
           ...
           * Public transitional route — no auth wrapper.
           * GitHub redirects here after the user grants (or denies) access.
           * The page handles its own auth state and redirects to the
